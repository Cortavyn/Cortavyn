...
class ModuleArchitectureTest {
    ...
    @ArchTest static final ArchRule chat_does_not_depend_on_higher_layers = noClasses().that().resideInAnyPackage("io.cortavyn.chat..").should().dependOnClassesThat().resideInAnyPackage("io.cortavyn.graph..", "io.cortavyn.deep..", "io.cortavyn.provider..");
    ...
    @ArchTest static final ArchRule deep_depends_only_on_graph_and_model_api = noClasses().that().resideInAnyPackage("io.cortavyn.deep..").should().dependOnClassesThat().resideInAnyPackage("io.cortavyn.core..", "io.cortavyn.chat..", "io.cortavyn.provider..");
}

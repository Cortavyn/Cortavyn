...
public record ChatMessage(
    ...
    public ChatMessage(ChatMessageRole role, String content) { this(role, content, List.of(new TextContent(content)), null, List.of()); }
    public ChatMessage(ChatMessageRole role, List<ChatContent> contentBlocks) { this(role, textContent(contentBlocks), contentBlocks, null, List.of()); }
    public static ChatMessage toolResult(String toolCallId, String content) { return new ChatMessage(ChatMessageRole.TOOL, content, List.of(new TextContent(content)), toolCallId, List.of()); }
